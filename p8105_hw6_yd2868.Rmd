...
I used LASSO to choose which variables are going to be used in the regression, and the results are: `r active_vars`. 

The plot of model residuals against fitted values is below
```{r}
plot
```
