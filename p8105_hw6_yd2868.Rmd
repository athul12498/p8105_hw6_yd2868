...
Based on 100 Monte-Carlo cross-validation splits, the LASSO-selected model achieves the lowest prediction error, indicating the best out-of-sample performance.
